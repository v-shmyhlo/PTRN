...
/***/ function(module, exports, __webpack_require__) {
	...
	var PTRN = _.rest(definePatternMatcher);

	PTRN._ = '__PTRN_WILDCARD';
	PTRN.P_DEF = '__PTRN_PARAMETER';
	PTRN.T_DEF = '__PTRN_TAIL';

	PTRN.P = function (pName) {
	  return _.merge({}, { _DEF: PTRN.P_DEF, name: pName });
	};
	PTRN.T = function (pName) {
	  return _.merge({}, { _DEF: PTRN.T_DEF, name: pName });
	};
	...
	function definePatternMatcher(defs) {
	  return function (target) {
	    ...
	    var def = _.find(defs, function (def) {
	      var pattern = _.first(def);
	      return bindings = matchPattern(target, pattern);
	    });

	    var handler = _.last(def);
